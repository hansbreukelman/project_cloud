...
class NaclConstruct(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, vpc_webserver, vpc_managementserver, **kwargs) -> None:
        ...
        #Inbound HTTP rule for the private webserver NACL.
        ...
        #Inbound HTTPS rule for the private webserver NACL.
        NACL_Ws_Private.add_entry(
        ...
        #Inbound Ephemeral rule for the private webserver NACL.
        NACL_Ws_Private.add_entry(
        ...
        #Outbound HTTP rule for the private webserver NACL.
        NACL_Ws_Private.add_entry(
        ...
        #Outbound HTTPS rule for the private webserver NACL.
        NACL_Ws_Private.add_entry(
        ...
        #Outbound Ephemeral rule for the private webserver NACL.
        NACL_Ws_Private.add_entry(
